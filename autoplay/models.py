...
class Element(models.Model):
    ...
    projectid = models.ForeignKey(Project,editable=True,on_delete=models.CASCADE)
    moduleid = models.ForeignKey(Module, editable=True,on_delete=models.CASCADE)
...
class Step(models.Model):
    ...
    elementid = models.ForeignKey(Element,null=True, blank=True,on_delete=models.CASCADE)
